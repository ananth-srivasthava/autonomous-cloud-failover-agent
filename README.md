...
<p align="center">
  <img src="Assets/incident-response.png" width="95%" alt="AI Incident Response">
</p>

Example Site Reliability Engineering (SRE) incident report generated by ARIA after detecting a cloud infrastructure failure.

---

## 🔀 Failover Routing Visualization

<p align="center">
  <img src="Assets/failover-routing.png" width="95%" alt="Failover Routing">
</p>

Visualization of the latency-aware failover path computed by Dijkstra's Shortest Path Algorithm.
